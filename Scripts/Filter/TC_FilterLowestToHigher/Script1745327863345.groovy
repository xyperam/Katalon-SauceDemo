...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Swag Labs/dropdown'),'lohi', false)
...
if (isSorted) {
	println("Harga sudah terurut dari terendah hingga tertinggi.")
} else {
